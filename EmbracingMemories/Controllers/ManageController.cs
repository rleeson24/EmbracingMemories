using EmbracingMemories.Models.Account;
	...
	public class ManageController : Controller
	{
		...
		public async Task<ActionResult> Index( ManageMessageId? message )
		{
			ViewBag.StatusMessage =
				...
				: "";
			ViewBag.Success = message != ManageMessageId.Error;
		...
		public async Task<ActionResult> ChangePassword( ChangePasswordViewModel model )
		{
			...
			if ( result.Succeeded )
			{
				...
				await EmailService.SendAsync( "Warrior's Guild - Password Changed", null, User.Identity.GetUserName(), "PasswordResetConfirmation" );
